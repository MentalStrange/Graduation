...
import { DoctorPrescriptionsContext } from '../../../../Context/DoctorContext/DoctorPrescriptionsContext';
...
function DoctorPrescriptions() {
  ...
  const { prescriptions, loading, error } = useContext(DoctorPrescriptionsContext);
  ...
  const currentItems = prescriptions && prescriptions.data ? prescriptions.data.slice(offset, offset + itemsPerPage) : [];
